...
//     // std::unordered_map<std::string, std::ostream*> streamMap = {
//     //     {"cout", &std::cout},
//     //     {"cerr", &std::cerr},
//     //     {"cout", &std::cout}
//     // };
...
//     for (auto& i : mStrTotype)
//     {
//         auto temp = var.getWord(i.first + "_stream");
//         if (temp.has_value())
//         {

//             auto stream     = mStreams[i.second];
//             auto streamName = temp.value();
